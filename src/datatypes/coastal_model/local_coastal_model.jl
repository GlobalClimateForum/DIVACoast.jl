export LocalCoastalImpactModel, CoastalImpactUnit,
  ...
  apply_accumulate, apply_accumulate_record, apply
  
using Distributions

abstract type CoastalImpactUnit end

mutable struct LocalCoastalImpactModel{DT<:Real} <: CoastalImpactUnit
...
function expected_damage_bathtub_standard_ddf(lcm::LocalCoastalImpactModel{DT}, hdd_area::DT, hdds_static::Array{DT}, hdds_dynamic::Array{DT}) where {DT<:Real}
...
expected_damage_bathtub_standard_ddf(lcm::LocalCoastalImpactModel{DT}, hdd_area::Real, hdds_static, hdds_dynamic) where {DT<:Real} = 
...
function expected_damage_bathtub(lcm::LocalCoastalImpactModel{DT}, ddf::Function, s::Symbol) where {DT<:Real}
...
exposure_below_bathtub(lcm::LocalCoastalImpactModel{DT}, e::Real) where {DT<:Real} = exposure_below_bathtub(lcm.coastal_plain_model, e)
exposure_below_bathtub(lcm::LocalCoastalImpactModel{DT}, e::Real, s::Symbol) where {DT<:Real} = exposure_below_bathtub(lcm.coastal_plain_model, s, e)

damage_bathtub_standard_ddf(lcm::LocalCoastalImpactModel{DT}, wl, hdd_area, hdds_static, hdds_dynamic) where {DT<:Real} = damage_standard_ddf(lcm.coastal_plain_model, wl, hdd_area, hdds_static, hdds_dynamic)
damage_bathtub_standard_ddf(lcm::LocalCoastalImpactModel{DT}, wl::T1, hdd::T2, s::Symbol) where {DT<:Real,T1<:Real,T2<:Real} = damage_standard_ddf(lcm.coastal_plain_model, s, convert(DT, wl), convert(DT, hdd))


function apply_accumulate(lm :: LocalCoastalImpactModel{DT}, f :: Function, accumulate :: Function) where {DT<:Real}
  return f(lm)
end

function apply_accumulate_record(lm :: LocalCoastalImpactModel{DT}, f :: Function, accumulate :: Function) where {DT<:Real}
  return f(lm)
end

function apply(lm :: LocalCoastalImpactModel{DT}, f :: Function) where {DT<:Real}
  f(lm)
end